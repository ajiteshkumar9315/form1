...
const RegisterForm = () => {
  ...
  <div className="col-md-5 m-3 mx-4">
    <label htmlFor="validationDefault05" className="form-label p-3">Mobile Number</label>
  ...
  <div className="col-12 m-5">
    <button className="btn btn-dark w-25 h-100 rounded-pill" type="submit" onClick={postData}>Submit </button>
  </div>
</form>
    </div>
  )
